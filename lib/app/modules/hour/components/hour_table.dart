...
class HourTable extends StatelessWidget {
  ...
  Widget siglaStyled(String sigla) {
    return Container(
      ...
      child: Text(sigla, style: const TextStyle(color: Colors.white)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: DataTable(
        columns: [
          DataColumn(label: tableTitleBar(hourModel.turno)),
        ...
        rows: hourModel.hours.map((item) {
          return DataRow(
            cells: [
              ...
              courseCell(sigla: item[1][0], descricao: item[1][1]),
              courseCell(sigla: item[2][0], descricao: item[2][1]),
              courseCell(sigla: item[3][0], descricao: item[3][1]),
              courseCell(sigla: item[4][0], descricao: item[4][1]),
              courseCell(sigla: item[5][0], descricao: item[5][1]),
